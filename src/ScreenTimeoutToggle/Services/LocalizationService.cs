...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
    {
        ["zh-CN"] = new()
        {
            ...
            ["monitor.page_keyboard"] = "Tab 循环切页，Shift+Tab 反向；F6 进入页面控件或返回页签",
            ...
            ["monitor.provider.codex"] = "OpenAI",
            ["monitor.provider.minimax"] = "MiniMax",
            ["monitor.provider.ark"] = "火山方舟",
            ["monitor.minimax.model.video"] = "视频赠送",
            ["monitor.window.primary"] = "主窗口",
            ["monitor.window.secondary"] = "次窗口",
            ["monitor.window.interval"] = "当前周期",
            ["monitor.window.weekly"] = "每周",
            ["monitor.window.monthly"] = "每月",
            ["monitor.window.session"] = "会话",
            ["monitor.window.5h"] = "5 小时",
            ["monitor.window.daily"] = "每日",
            ["monitor.window.day"] = "当日",
            ["monitor.window.session_short"] = "短周期",
            ["monitor.window.session_badge"] = "当前会话",
            ...
            ["monitor.quota_all_disabled"] = "没有已启用的额度来源 · 在设置页开启后开始查询",
            ...
            ["monitor.percent_used_only"] = "已用 {0}%",
            ["monitor.unlimited"] = "∞ 无限制",
            ["monitor.reset_in"] = "后重置",
            ["monitor.reset_credits_count"] = "可用 {0} 次",
            ["monitor.percent_out_of_range"] = "数值异常（{0}%）",
            ["monitor.not_provided"] = "未提供",
            ["monitor.counts"] = "{0}/{1} 次",
            ["monitor.counts_used"] = "已用 {0} / {1} 次",
            ["monitor.credit_expiry_suffix"] = "到期",
            ...
            ["monitor.metric_physical"] = "物理内存",
            ["monitor.metric_commit"] = "提交内存",
            ["monitor.range_1m"] = "1 分钟",
            ["monitor.range_10m"] = "10 分钟",
            ["monitor.range_30m"] = "30 分钟",
            ["monitor.range_1h"] = "1 小时",
        ...
        ["en-US"] = new()
        {
            ...
            ["monitor.page_keyboard"] = "Tab cycles pages; Shift+Tab reverses. F6 enters controls or returns to page tabs.",
            ...
            ["monitor.minimax.model.video"] = "Video gift",
            ["monitor.window.primary"] = "Primary window",
            ["monitor.window.secondary"] = "Secondary window",
            ["monitor.window.interval"] = "Current cycle",
            ["monitor.window.weekly"] = "Weekly",
            ["monitor.window.monthly"] = "Monthly",
            ["monitor.window.session"] = "Session",
            ["monitor.window.5h"] = "5 hours",
            ["monitor.window.daily"] = "Daily",
            ["monitor.window.day"] = "Daily",
            ["monitor.window.session_short"] = "Short period",
            ["monitor.window.session_badge"] = "Current session",
            ...
            ["monitor.quota_all_disabled"] = "No quota source is enabled — enable one on the settings page to start querying",
            ...
            ["monitor.percent_used_only"] = "Used {0}%",
            ["monitor.unlimited"] = "∞ Unlimited",
            ["monitor.reset_in"] = "resets",
            ["monitor.reset_credits_count"] = "{0} available",
            ["monitor.percent_out_of_range"] = "Invalid value ({0}%)",
            ["monitor.not_provided"] = "Not provided",
            ["monitor.counts"] = "{0}/{1} calls",
            ["monitor.counts_used"] = "used {0} / {1}",
            ["monitor.credit_expiry_suffix"] = "expires",
            ...
            ["monitor.metric_physical"] = "Physical memory",
            ["monitor.metric_commit"] = "Commit memory",
            ["monitor.range_1m"] = "1 min",
            ["monitor.range_10m"] = "10 min",
            ["monitor.range_30m"] = "30 min",
            ["monitor.range_1h"] = "1 hr",
